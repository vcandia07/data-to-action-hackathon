...
```
Azure SQL Server:    sqlhackatondatosaccion.database.windows.net
Base de datos:       AdventureWorksLT
Tipo Autenticación:  Basica
Usuario:             usr_read
Contraseña:          P@ssw0rd_Segura123!

ADLS Gen2:
Cuenta de almacenamiento: dlshackatondatosaccion
Contenedor:               datadummy
Tipo de autenticación:    SAS
URL: https://dlshackatondatosaccion.dfs.core.windows.net/
SAS: sv=2024-11-04&ss=bfqt&srt=sco&sp=rwdlacupyx&se=2026-03-31T06:49:24Z&st=2026-03-18T22:34:24Z&spr=https&sig=eQZTZaiUZ8IAlBl66ACpHGKboqsrL0YnemcjhfFaRxo%3D
```
